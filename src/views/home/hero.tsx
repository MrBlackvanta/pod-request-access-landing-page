export default function Hero() {
  return (
    <main className="md:bg-page mt-14 text-center md:mt-26 md:max-w-148 md:pt-22 md:text-left lg:max-w-184">
      ...
      <p className="text-lead text-copy md:text-lead-lg mt-4 md:mt-6 md:max-w-112">
